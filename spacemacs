...
you should place your code here."
  ...
  (key-chord-define-global ";r" 'vr/replace)
  (key-chord-define-global ";q" 'vr/query-replace)
  (key-chord-define-global ";m" 'vr/mc-mark)
  )
